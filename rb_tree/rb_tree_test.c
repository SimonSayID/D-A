...
void rb_tree_test() {
    ...
    assert(rb_is_black(root->right));
    assert(rb_is_red(root->right->left));
    assert(rb_is_red(root->right->right));
    ...
    assert(rb_is_black(root->left));
    assert(rb_is_red(root->left->left));
    assert(rb_is_red(root->left->right));
    ...
    root = rb_tree_delete(root, 30);
    assert(rb_is_red(root->right));
    assert(rb_is_black(root->right->left));
    assert(rb_is_black(root->right->right));
